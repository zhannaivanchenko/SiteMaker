      ...
      <div className="container text-center mt-5">
        ...
        <div className="row portofolioDescription justify-content-center my-2">
          <p className="col-8 text-center ">
            Eum cu legere complecitur, hinc utamur ea eam. Eum patrioque
            mnesaechum eu, diam erant conveniere et vis. Et essent evertjtur
            sea, vis cu ubique referrentur, sed eu dicant expectendis.
          </p>
        </div>
        <PortofolioFilter
